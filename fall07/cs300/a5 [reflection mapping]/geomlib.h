///////////////////////////////////////////////////////////////////////
// $Id: geomlib.h 1053 2007-09-14 04:41:08Z gherron $
//
...
// Functions
bool Intersects(const Line2D& l1, const Line2D& l2, Point2D *p=0);
...
public:
	// Constructor
	LineSeg2D() : point1(), point2() {return;}
...
// Functions
bool Intersects(const LineSeg2D& l1, const LineSeg2D& l2, Point2D *p=0);
...
bool Intersects(const Line3D& l, const Plane3D& p, Point3D *m=0); 
...
public:
	// Constructors
	LineSeg3D() : point1(), point2() {return;}
...
// Functions
bool Intersects(const LineSeg3D& l, const Triangle3D& t, Point3D *p=0);
...
public:
	...
	// Utility method
    bool contains(const Point3D& p, float *t=0) const;
...
bool Intersects(const Ray3D& r, const Triangle3D& t,
				Point3D *p=0);
int Intersects(const Ray3D& r, const Box3D& b,
			   std::pair<Point3D, Point3D> *p=0);
...
public:
	...
	float Evaluate(Point3D p) { return crds[0]*p[0] + crds[1]*p[1] + crds[2]*p[2] + crds[3]; }
