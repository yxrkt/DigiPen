///////////////////////////////////////////////////////////////////////
// $Id: geomlib.h 1210 2008-02-05 17:45:17Z gherron $
//
...
// VC warning: "C++ exception specification ignored..."
#pragma warning(push)
#pragma warning(disable: 4290)

// VC warning: unsafe parameters
...
public:
	...
	explicit Vector4D(Vector3D V)
		{ crds[0]=V[0]; crds[1]=V[1]; crds[2]=V[2]; crds[3]=0.0; }
	explicit Vector4D(Point3D P)
