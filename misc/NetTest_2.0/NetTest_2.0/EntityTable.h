/*!*************************************************************************************************
    ...
    @brief  This is the interface for the entity table used by networking. This allows multiple
            machines to keep track of the same entity using their own identifications.
